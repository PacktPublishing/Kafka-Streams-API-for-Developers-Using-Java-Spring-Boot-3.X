...
class OrdersTopologyTest {
    ...
    void ordersRevenue_byWindows() {
        ...
        WindowStore<String, TotalRevenue> restaurantOrdersRevenue = topologyTestDriver.getWindowStore(RESTAURANT_ORDERS_REVENUE_WINDOW);
        ...
        restaurantOrdersRevenue
                ...
                .forEachRemaining(windowedTotalRevenueKeyValue -> {
                    ...
                    assert  LocalDateTime.ofInstant(startTime, ZoneId.of(ZoneId.SHORT_IDS.get("CST"))).isEqual(expectedStartTime);
                    assert  LocalDateTime.ofInstant(endTime, ZoneId.of(ZoneId.SHORT_IDS.get("CST"))).isEqual(expectedEndTime);
