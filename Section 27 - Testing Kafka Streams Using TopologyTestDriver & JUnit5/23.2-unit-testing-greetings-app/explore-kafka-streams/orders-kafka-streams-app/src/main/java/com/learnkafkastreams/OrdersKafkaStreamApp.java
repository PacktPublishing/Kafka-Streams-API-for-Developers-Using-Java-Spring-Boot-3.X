...
public class OrdersKafkaStreamApp {
    ...
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "orders-app-1"); // consumer group
        ...
        createTopics(config, List.of(STORES, OrdersTopology.RESTAURANT_ORDERS,OrdersTopology.GENERAL_ORDERS,
